//----------------------------------------------------------
//
//   Thin dispatcher around the Pawn AMX function table that the host server
//   (open.mp IPawnComponent) hands to components. Derived from the original
//   SA-MP amxplugin.cpp (Copyright 2004-2009 SA-MP Team); stripped of all
//   SA-MP-specific headers so it depends only on Pawn VM types.
//
//----------------------------------------------------------

#include "amx/amx.h"
#include "amx_exports.h"
